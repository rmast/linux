...
/*
 * Only ATOMISP_IOC_S_EXPOSURE remains: it is still used by the legacy
 * gc2235 and ov2722 sensor drivers. All other private ISP ioctls had no
 * remaining in-tree users after the vidioc_default dispatcher removal and
 * were removed (see atomisp-must1-private-ioctl-inventory.md evidence).
 */
